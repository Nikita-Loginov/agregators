...
export const chartsItems = {
  Dubai: {
    ...
    name: "Dubai",
    classBadge: 'badge--gray-color-200 badge--middle',
    classBadgeDot: 'dot--primary-color-100',
    classBtn: "button--bg-primary-200 button--rounded-2xl button--md",
    
  },
  Moscow: {
    label: "Moscow median price",
    ...
    name: "Moscow",
    classBadge: 'badge--gray-color-200 badge--middle',
    classBadgeDot: 'dot--secondary-color-100',
    classBtn: "button--bg-secondary-200 button--rounded-2xl button--md",
  },
  Germany: {
    label: "Germany median price",
    data: [700, 410, 725, 540, 620, 260, 570, 480, 590, 310, 630, 450],
    borderColor: "#26b539",
    backgroundColor: "#26b53980",
    pointBackgroundColor: "#26b539",
    pointBorderColor: "#FFFFFF",
    pointBorderWidth: 2,
    pointRadius: window.innerWidth <= 768 ? 0 : 6,
    pointHoverRadius: 8,
    ...
    name: "Germany",
    classBadge: 'badge--gray-color-200 badge--middle',
    classBadgeDot: 'dot--green-color-100',
    classBtn: "button--bg-green-100 button--rounded-2xl button--md",
  },
};
